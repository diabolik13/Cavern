...
def load_input(mesh_filename):
    ...
    kb = 1.8115e10
    mu = 9.842e9
    pr = 8e6  # cavern and lithostatic pressure difference, [Pa]  # changed to 3e6
    dof = 2  # degrees of freedom, [-]
    nt = 25  # number of time steps, [-]
    a = 1e-21  # creep material constant, [Pa]^n
    n = 5  # creep material constant, [-]
    th = 1000  # thickness of the model in z, [m]
    # th = 1
    ...
    d_bnd = np.concatenate((b_bnd, t_bnd, l_bnd))  # Used for right boundary
